...
from app.core.forge_log import ForgeLogger
...
@base_router.get("/agent/tasks/{task_id}/steps", tags=["agent"], response_model=TaskStepsListResponse)
...
@base_router.get("/agent/tasks/{task_id}/steps/{step_id}", tags=["agent"], response_model=Step)
...
@base_router.get("/agent/tasks/{task_id}/artifacts",tags=["agent"],response_model=TaskArtifactsListResponse,)
...
@base_router.get("/agent/tasks/{task_id}/artifacts/{artifact_id}", tags=["agent"], response_model=str)
...
@base_router.post("/agent/tasks/{task_id}/artifacts", tags=["agent"], response_model=Artifact)
