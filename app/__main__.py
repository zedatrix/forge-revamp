...
import app.core.forge_log

LOG = app.core.forge_log.ForgeLogger(__name__)
...
if __name__ == "__main__":
    ...
    load_dotenv()
    app.core.forge_log.setup_logger()

    uvicorn.run(
        "app.app:app", host="0.0.0.0", port=int(port), log_level="error", reload=True
    )
